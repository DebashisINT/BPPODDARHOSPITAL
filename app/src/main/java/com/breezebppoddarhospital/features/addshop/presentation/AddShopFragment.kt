package com.breezebppoddarhospital.features.addshop.presentation
...
import com.breezebppoddarhospital.features.NewQuotation.AddQuotFormFragment
...
import com.breezebppoddarhospital.features.dashboard.presentation.ShopVerificationDialog
import com.breezebppoddarhospital.features.dashboard.presentation.VisitRemarksTypeAdapter
...
import com.breezebppoddarhospital.features.location.model.ShopDurationRequestData
...
import com.breezebppoddarhospital.features.login.model.GetQtsAnsSubmitDtlsResponseModel
...
import com.breezebppoddarhospital.features.photoReg.PhotoRegAadhaarFragment
import com.breezebppoddarhospital.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebppoddarhospital.features.viewAllOrder.interf.QaOnCLick
import com.breezebppoddarhospital.features.viewAllOrder.orderOptimized.CustomProductRate
...
// mantis id 26741 Storage permission updation Suman 22-08-2023
    ...
    private fun getAssignedDDListApi(shopAdded: Boolean, shop_id: String?) {
        println("tag_shop_add_flow getAssignedDDListApi")
        ...
        BaseActivity.compositeDisposable.add(
            repository.assignToDDList(Pref.profile_state)
                ...
                .subscribe({ result ->
                    ...
                    println("tag_shop_add_flow getAssignedDDListApi response ${response.status}")
                    if (response.status == NetworkConstant.SUCCESS) {
    ...
    private fun getAssignedToShopApi(shopAdded: Boolean, shop_id: String?) {
        println("tag_shop_add_flow getAssignedToShopApi")
        val repository = TypeListRepoProvider.provideTypeListRepository()
        progress_wheel.spin()
        BaseActivity.compositeDisposable.add(
            repository.assignToShopList(Pref.profile_state)
                ...
                .subscribe({ result ->
                    ...
                    println("tag_shop_add_flow getAssignedToShopApi response ${response.status}")
                    if (response.status == NetworkConstant.SUCCESS) {
