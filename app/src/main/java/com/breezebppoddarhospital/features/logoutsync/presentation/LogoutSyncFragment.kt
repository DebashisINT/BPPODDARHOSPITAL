package com.breezebppoddarhospital.features.logoutsync.presentation
...
import com.breezebppoddarhospital.app.AppDatabase
...
import com.breezebppoddarhospital.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezebppoddarhospital.features.billing.api.AddBillingRepoProvider
import com.breezebppoddarhospital.features.billing.model.AddBillingInputParamsModel
...
import com.breezebppoddarhospital.features.dashboard.presentation.ReasonDialog
...
import com.breezebppoddarhospital.features.document.model.AddEditDocumentInputParams
import com.breezebppoddarhospital.features.document.model.DocumentAttachmentModel
...
import com.breezebppoddarhospital.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezebppoddarhospital.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezebppoddarhospital.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezebppoddarhospital.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezebppoddarhospital.features.orderhistory.model.*
...
import com.breezebppoddarhospital.features.quotation.model.AddQuotInputModel
import com.breezebppoddarhospital.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebppoddarhospital.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezebppoddarhospital.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezebppoddarhospital.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezebppoddarhospital.features.timesheet.model.AddTimeSheetInputModel
import com.breezebppoddarhospital.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezebppoddarhospital.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezebppoddarhospital.features.viewAllOrder.model.AddOrderInputProductList
import com.breezebppoddarhospital.mappackage.SendBrod
import com.breezebppoddarhospital.widgets.AppCustomTextView
import com.breezebppoddarhospital.MonitorService
import com.breezebppoddarhospital.MySingleton
...
import com.breezebppoddarhospital.features.addshop.presentation.ShopExtraContactReq
...
import com.breezebppoddarhospital.features.login.model.GetConcurrentUserResponse
import com.breezebppoddarhospital.features.login.model.WhatsappApiData
import com.breezebppoddarhospital.features.orderITC.SyncOrd
import com.breezebppoddarhospital.features.orderITC.SyncOrdProductL
import com.breezebppoddarhospital.features.performance.model.Gps_status_list
import com.breezebppoddarhospital.features.performance.model.UpdateGpsInputListParamsModel
import com.breezebppoddarhospital.features.returnsOrder.ReturnProductList
import com.breezebppoddarhospital.features.returnsOrder.ReturnRequest
import com.breezebppoddarhospital.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebppoddarhospitallogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebppoddarhospitallogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebppoddarhospitallogsample/log.zip").path);
