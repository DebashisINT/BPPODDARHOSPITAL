package com.breezebppoddar.features.mylearning
...
import com.breezebppoddar.features.contacts.CustomData
import com.breezebppoddar.features.contacts.GenericDialog
import com.breezebppoddar.features.contacts.GenericDialogWithOutSearch
import com.breezebppoddar.features.dashboard.presentation.DashboardActivity
import com.breezebppoddar.features.leaderboard.AdapterSubBranchName
import com.breezebppoddar.features.leaderboard.LeaderBoardFilterOnDurationData
import com.breezebppoddar.features.leaderboard.api.BranchData
import com.breezebppoddar.features.leaderboard.api.LeaderboardBranchData
import com.breezebppoddar.features.leaderboard.api.LeaderboardRepoProvider
import com.breezebppoddar.features.leaderboard.api.SubBranchData
import com.breezebppoddar.features.mylearning.apiCall.LMSRepoProvider
    ...
    private fun initView(view: View) {
      ...
      //  tv_lms_leaderboard.setTextColor(getResources().getColor(R.color.toolbar_lms))
        ...
        if (AppUtils.isOnline(mContext)){
            ...
            //if(CustomStatic.IsLMSLeaderboardClick == true){
                showInitialPopupData()

           /* }else{
                CustomStatic.IsLMSLeaderboardClick = false
            }*/
                    ...
                    .subscribe({ result ->
                        if(result.status == NetworkConstant.SUCCESS) {
                            try {
                                ...
                                showPopup(view!! , needscore ,userTotalScore)
