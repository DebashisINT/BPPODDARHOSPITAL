package com.breezebppoddar.features.commondialogsinglebtn
...
import com.breezebppoddar.app.domain.ShopVisitCompetetorModelEntity
import com.breezebppoddar.app.domain.VisitRemarksEntity
...
import com.breezebppoddar.features.addshop.presentation.ProspectListDialog
import com.breezebppoddar.features.dashboard.presentation.DashboardActivity
import com.breezebppoddar.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezebppoddar.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezebppoddar/files", "recorded_audio${System.currentTimeMillis()}.mp3")
