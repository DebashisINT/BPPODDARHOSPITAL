package com.breezebppoddar.features.logoutsync.presentation
...
import com.breezebppoddar.app.utils.Toaster
import com.breezebppoddar.base.BaseResponse
import com.breezebppoddar.base.presentation.BaseActivity
import com.breezebppoddar.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezebppoddar.features.billing.api.AddBillingRepoProvider
import com.breezebppoddar.features.billing.model.AddBillingInputParamsModel
...
import com.breezebppoddar.features.dashboard.presentation.ReasonDialog
...
import com.breezebppoddar.features.document.model.AddEditDocumentInputParams
import com.breezebppoddar.features.document.model.DocumentAttachmentModel
...
import com.breezebppoddar.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezebppoddar.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezebppoddar.features.orderhistory.model.*
...
import com.breezebppoddar.features.quotation.model.AddQuotInputModel
import com.breezebppoddar.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebppoddar.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezebppoddar.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezebppoddar.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezebppoddar.features.timesheet.model.AddTimeSheetInputModel
import com.breezebppoddar.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezebppoddar.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezebppoddar.features.viewAllOrder.model.AddOrderInputProductList
import com.breezebppoddar.mappackage.SendBrod
import com.breezebppoddar.widgets.AppCustomTextView
import com.breezebppoddar.MonitorService
import com.breezebppoddar.MySingleton
import com.breezebppoddar.app.AlarmReceiver
import com.breezebppoddar.features.addshop.model.*
import com.breezebppoddar.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezebppoddar.features.addshop.presentation.ShopExtraContactReq
import com.breezebppoddar.features.addshop.presentation.multiContactRequestData
...
import com.breezebppoddar.features.login.model.GetConcurrentUserResponse
import com.breezebppoddar.features.login.model.WhatsappApiData
import com.breezebppoddar.features.orderITC.SyncDeleteOppt
import com.breezebppoddar.features.orderITC.SyncDeleteOpptL
import com.breezebppoddar.features.orderITC.SyncEditOppt
import com.breezebppoddar.features.orderITC.SyncOppt
import com.breezebppoddar.features.orderITC.SyncOpptProductL
import com.breezebppoddar.features.orderITC.SyncOrd
import com.breezebppoddar.features.orderITC.SyncOrdProductL
import com.breezebppoddar.features.performance.model.Gps_status_list
import com.breezebppoddar.features.performance.model.UpdateGpsInputListParamsModel
import com.breezebppoddar.features.returnsOrder.ReturnProductList
import com.breezebppoddar.features.returnsOrder.ReturnRequest
import com.breezebppoddar.features.viewAllOrder.model.NewOrderSaveApiModel
...
//                    }
    ...
    fun syncAudioDataNew(){
        try {
                ...
                BaseActivity.compositeDisposable.add(
                    repository.syncNewShopAudio(objSync, obj.audio_path, mContext)
                        ...
                        .subscribe({ result ->
                            ...
                            calllogoutApi(Pref.user_id!!, Pref.session_token!!)
                            Timber.d("tag_sync_audio err ${error.printStackTrace()}")
                        })
                )
            }else{
                calllogoutApi(Pref.user_id!!, Pref.session_token!!)
            ...
            Timber.d("tag_sync_audio err ${e.printStackTrace()}")
            calllogoutApi(Pref.user_id!!, Pref.session_token!!)
        }
    }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebppoddarlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebppoddarlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebppoddarlogsample/log.zip").path);
