package com.bppoddarfsm.features.logoutsync.presentation
...
import com.bppoddarfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.bppoddarfsm.features.billing.api.AddBillingRepoProvider
import com.bppoddarfsm.features.billing.model.AddBillingInputParamsModel
...
import com.bppoddarfsm.features.dashboard.presentation.ReasonDialog
...
import com.bppoddarfsm.features.document.model.AddEditDocumentInputParams
import com.bppoddarfsm.features.document.model.DocumentAttachmentModel
...
import com.bppoddarfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.bppoddarfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.bppoddarfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.bppoddarfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.bppoddarfsm.features.orderhistory.model.*
...
import com.bppoddarfsm.features.quotation.model.AddQuotInputModel
import com.bppoddarfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.bppoddarfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.bppoddarfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.bppoddarfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.bppoddarfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.bppoddarfsm.features.timesheet.model.AddTimeSheetInputModel
...
import com.bppoddarfsm.MonitorService
import com.bppoddarfsm.MySingleton
...
import com.bppoddarfsm.features.addshop.presentation.ShopExtraContactReq
import com.bppoddarfsm.features.addshop.presentation.multiContactRequestData
import com.bppoddarfsm.features.login.api.LoginRepositoryProvider
import com.bppoddarfsm.features.login.model.GetConcurrentUserResponse
import com.bppoddarfsm.features.login.model.WhatsappApiData
import com.bppoddarfsm.features.performance.model.Gps_status_list
import com.bppoddarfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.bppoddarfsm.features.returnsOrder.ReturnProductList
import com.bppoddarfsm.features.returnsOrder.ReturnRequest
import com.bppoddarfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbppoddarfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbppoddarfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbppoddarfsmlogsample/log.zip").path);
